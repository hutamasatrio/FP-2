...
public class RecyclerAdapterFav extends RecyclerView.Adapter<RecyclerAdapterFav.MyViewHolder> {
    ...
    private List<ItemFav> Produk ;
    ItemFav dataContent;

    public RecyclerAdapterFav(Context mContext, List<ItemFav> Produk) {
        this.mContext = mContext;
        this.Produk = Produk;
    }


    public RecyclerAdapterFav.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view ;
        LayoutInflater mInflater = LayoutInflater.from(mContext);
        view = mInflater.inflate(R.layout.card,parent,false);
        return new RecyclerAdapterFav.MyViewHolder(view);
    }

    public void onBindViewHolder(RecyclerAdapterFav.MyViewHolder holder, final int position) {
