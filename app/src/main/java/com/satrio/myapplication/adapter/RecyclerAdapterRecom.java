...
public class RecyclerAdapterRecom extends RecyclerView.Adapter<RecyclerAdapterRecom.MyViewHolder> {
    private Context mContext ;
    private List<ItemRecom> Produk ;
    ItemRecom dataContent;

    public RecyclerAdapterRecom(Context mContext, List<ItemRecom> Produk) {
        this.mContext = mContext;
        this.Produk = Produk;
    }


    public RecyclerAdapterRecom.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view ;
        LayoutInflater mInflater = LayoutInflater.from(mContext);
        view = mInflater.inflate(R.layout.card,parent,false);
        return new RecyclerAdapterRecom.MyViewHolder(view);
    }

    public void onBindViewHolder(RecyclerAdapterRecom.MyViewHolder holder, final int position) {
